...
use std::{ffi::OsStr, iter, iter::FusedIterator, path::Path, slice};
...
///
/// [rfc7231]: https://tools.ietf.org/html/rfc7231#section-3.1.1.5
#[deprecated(since = "2.0.0", note = "Use `from_path(path).first_or_octet_stream()` instead")]
...
///
/// [rfc7231]: https://tools.ietf.org/html/rfc7231#section-3.1.1.5
#[deprecated(since = "2.0.0", note = "use `from_ext(search_ext).first_or_octet_stream()` instead")]
...
#[deprecated(since = "2.0.0", note = "use `from_ext(search_ext).first_raw()` instead")]
