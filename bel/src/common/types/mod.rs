...
pub const TIMESTAMP_TYPE: Type = Type {
    ...
    trait_mask: traits::ADDER_TYPE | traits::COMPARER_TYPE | traits::RECEIVER_TYPE | traits::SUBTRACTOR_TYPE,
};
...
impl<'a> Type<'a> {
    ...
    pub const fn new_map_type<'b>(param: &'b [&'b Type<'b>; 2]) -> Type<'b> {
        Type {
            ...
            trait_mask: traits::CONTAINER_TYPE | traits::INDEXER_TYPE | traits::ITERABLE_TYPE | traits::SIZER_TYPE,
        }
    }
