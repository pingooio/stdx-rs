...
use antlr4rust::{
    PredictionContextCache, TidAble, TidExt, TokenSource,
    atn::{ATN, INVALID_ALT},
    ...
    parser_rule_context::{BaseParserRuleContext, ParserRuleContext, cast, cast_mut},
    recognizer::{Actions, Recognizer},
    rule_context::{BaseRuleContext, CustomRuleContext, RuleContext},
    token::{OwningToken, TOKEN_EOF, Token},
...
use super::{cellistener::*, celvisitor::*};
...
pub type CELTreeWalker<'input, 'a> = ParseTreeWalker<'input, 'a, CELParserContextType, dyn CELListener<'input> + 'a>;
    ...
    Actions<'input, BaseParserType<'input, I>> for CELParserExt<'input>
{
    ...
    fn sempred(
        ...
        match rule_index {
            4 => {
                CELParser::<'input, I, _>::relation_sempred(_localctx.and_then(|x| x.downcast_ref()), pred_index, recog)
            }
                                ...
                                1 => {
                                    {
                                        ...
                                        if !(((_la) & !0x3f) == 0
                                            && ((1usize << _la)
                                                & ((1usize << STAR) | (1usize << SLASH) | (1usize << PERCENT)))
                                                != 0)
                                        {
                                            let tmp = recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input> UnaryContextExt<'input> {
    fn new(
        ...
        Rc::new(UnaryContextAll::Error(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            UnaryContextExt {
                ph: PhantomData,
...
impl<'input> LogicalNotContextExt<'input> {
    fn new(ctx: &dyn UnaryContextAttrs<'input>) -> Rc<UnaryContextAll<'input>> {
        Rc::new(UnaryContextAll::LogicalNotContext(BaseParserRuleContext::copy_from(
            ctx,
...
impl<'input> MemberExprContextExt<'input> {
    fn new(ctx: &dyn UnaryContextAttrs<'input>) -> Rc<UnaryContextAll<'input>> {
        Rc::new(UnaryContextAll::MemberExprContext(BaseParserRuleContext::copy_from(
            ctx,
...
impl<'input> NegateContextExt<'input> {
    fn new(ctx: &dyn UnaryContextAttrs<'input>) -> Rc<UnaryContextAll<'input>> {
        Rc::new(UnaryContextAll::NegateContext(BaseParserRuleContext::copy_from(
            ctx,
            NegateContextExt {
                s18: None,
                ops: Vec::new(),
...
impl<'input> MemberContextExt<'input> {
    fn new(
        ...
        Rc::new(MemberContextAll::Error(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            MemberContextExt {
                ph: PhantomData,
...
impl<'input> MemberCallContextExt<'input> {
    fn new(ctx: &dyn MemberContextAttrs<'input>) -> Rc<MemberContextAll<'input>> {
        Rc::new(MemberContextAll::MemberCallContext(BaseParserRuleContext::copy_from(
            ctx,
...
impl<'input> SelectContextExt<'input> {
    fn new(ctx: &dyn MemberContextAttrs<'input>) -> Rc<MemberContextAll<'input>> {
        Rc::new(MemberContextAll::SelectContext(BaseParserRuleContext::copy_from(
            ctx,
            SelectContextExt {
                op: None,
                opt: None,
...
impl<'input> PrimaryExprContextExt<'input> {
    fn new(ctx: &dyn MemberContextAttrs<'input>) -> Rc<MemberContextAll<'input>> {
        Rc::new(MemberContextAll::PrimaryExprContext(BaseParserRuleContext::copy_from(
            ctx,
...
impl<'input> IndexContextExt<'input> {
    fn new(ctx: &dyn MemberContextAttrs<'input>) -> Rc<MemberContextAll<'input>> {
        Rc::new(MemberContextAll::IndexContext(BaseParserRuleContext::copy_from(
            ctx,
            IndexContextExt {
                op: None,
                opt: None,
...
impl<'input> PrimaryContextExt<'input> {
    fn new(
        ...
        Rc::new(PrimaryContextAll::Error(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            PrimaryContextExt {
                ph: PhantomData,
...
impl<'input> CreateListContextExt<'input> {
    fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>> {
        Rc::new(PrimaryContextAll::CreateListContext(BaseParserRuleContext::copy_from(
            ctx,
...
impl<'input> IdentContextExt<'input> {
    fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>> {
        Rc::new(PrimaryContextAll::IdentContext(BaseParserRuleContext::copy_from(
            ctx,
            IdentContextExt {
                leadingDot: None,
                id: None,
...
impl<'input> CreateStructContextExt<'input> {
    fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>> {
        Rc::new(PrimaryContextAll::CreateStructContext(BaseParserRuleContext::copy_from(
            ctx,
...
impl<'input> ConstantLiteralContextExt<'input> {
    fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>> {
        Rc::new(PrimaryContextAll::ConstantLiteralContext(BaseParserRuleContext::copy_from(
            ctx,
...
impl<'input> NestedContextExt<'input> {
    fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>> {
        Rc::new(PrimaryContextAll::NestedContext(BaseParserRuleContext::copy_from(
            ctx,
            NestedContextExt {
                e: None,
                base: ctx.borrow().clone(),
...
impl<'input> CreateMessageContextExt<'input> {
    fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>> {
        Rc::new(PrimaryContextAll::CreateMessageContext(BaseParserRuleContext::copy_from(
            ctx,
...
impl<'input> GlobalCallContextExt<'input> {
    fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>> {
        Rc::new(PrimaryContextAll::GlobalCallContext(BaseParserRuleContext::copy_from(
            ctx,
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn fieldInitializerList(&mut self) -> Result<Rc<FieldInitializerListContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn mapInitializerList(&mut self) -> Result<Rc<MapInitializerListContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> EscapeIdentContextExt<'input> {
    fn new(
        ...
        Rc::new(EscapeIdentContextAll::Error(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            EscapeIdentContextExt {
                ph: PhantomData,
            },
        )))
    }
...
impl<'input> LiteralContextExt<'input> {
    fn new(
        ...
        Rc::new(LiteralContextAll::Error(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            LiteralContextExt {
                ph: PhantomData,
...
impl<'input> BytesContextExt<'input> {
    fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>> {
        Rc::new(LiteralContextAll::BytesContext(BaseParserRuleContext::copy_from(
            ctx,
            BytesContextExt {
                tok: None,
                base: ctx.borrow().clone(),
...
impl<'input> UintContextExt<'input> {
    fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>> {
        Rc::new(LiteralContextAll::UintContext(BaseParserRuleContext::copy_from(
            ctx,
            UintContextExt {
                tok: None,
                base: ctx.borrow().clone(),
...
impl<'input> NullContextExt<'input> {
    fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>> {
        Rc::new(LiteralContextAll::NullContext(BaseParserRuleContext::copy_from(
            ctx,
            NullContextExt {
                tok: None,
                base: ctx.borrow().clone(),
...
impl<'input> BoolFalseContextExt<'input> {
    fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>> {
        Rc::new(LiteralContextAll::BoolFalseContext(BaseParserRuleContext::copy_from(
            ctx,
            BoolFalseContextExt {
                tok: None,
                base: ctx.borrow().clone(),
...
impl<'input> StringContextExt<'input> {
    fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>> {
        Rc::new(LiteralContextAll::StringContext(BaseParserRuleContext::copy_from(
            ctx,
            StringContextExt {
                tok: None,
                base: ctx.borrow().clone(),
...
impl<'input> DoubleContextExt<'input> {
    fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>> {
        Rc::new(LiteralContextAll::DoubleContext(BaseParserRuleContext::copy_from(
            ctx,
            DoubleContextExt {
                sign: None,
                tok: None,
...
impl<'input> BoolTrueContextExt<'input> {
    fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>> {
        Rc::new(LiteralContextAll::BoolTrueContext(BaseParserRuleContext::copy_from(
            ctx,
            BoolTrueContextExt {
                tok: None,
                base: ctx.borrow().clone(),
...
impl<'input> IntContextExt<'input> {
    fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>> {
        Rc::new(LiteralContextAll::IntContext(BaseParserRuleContext::copy_from(
            ctx,
            IntContextExt {
                sign: None,
                tok: None,
...
const _serializedATN: &str = "\x03\u{608b}\u{a72a}\u{8133}\u{b9ed}\u{417c}\u{3be7}\u{7786}\u{5964}\x03\
