...
[![Rust](https://github.com/bloom42/bel-rs/actions/workflows/rust.yml/badge.svg)](https://github.com/bloom42/bel-rs/actions/workflows/rust.yml)
...
resource.name.starts_with("/groups/" + auth.claims.group)
```
...
`bel-rs` is a fork of https://github.com/bloom42/bel-rs commit 8287d04156a1b31efe0dd53db78e943fef15c59a
